...
const sv: Dict = {
  ...
  "mock.app.plan":
    "PÅ RIKTIGT: planen, faserna och passen är genererade av Parrots motor. MOCK: vald löpare och datum är exempeldata.",
...
const en: Dict = {
  ...
  "mock.app.plan":
    "REAL: the plan, phases and sessions are generated by Parrot's engine. MOCK: the chosen athlete and dates are sample data.",
