...
/* ============================================================================
   VALIDATED GENERATION CORE — the single path every v2 surface uses to turn
   ...
   It calls only the SHARED engine (generatePlan) and the SHARED validation layer
   (validatePlanProgression / validateSessionVariety / containsInstructionLeak) —
   no duplicated training logic. Pure & deterministic, so it is unit-testable with
   the generator mocked and the real validation running.
   ============================================================================ */
