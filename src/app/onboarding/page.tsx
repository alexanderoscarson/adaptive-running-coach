...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 lg:w-[45%] bg-gradient-to-br from-primary to-violet-500 items-center justify-center p-12 relative">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <div className="md:hidden h-24 relative mx-4 mt-4 rounded-2xl overflow-hidden bg-gradient-to-r from-primary to-violet-500 flex items-center justify-center gap-3">
